...
| AI 파이프라인 Step3 — 이동 동선 보강 (`enrich_routes`) | ⬜ | | 🔴 | LLM 안 씀. 길찾기 프로바이더는 네이버(신규가입 차단)→카카오모빌리티(대중교통 미지원 확인)→ODsay로 정정 확정(2026-08-09). ODsay API 키 발급 + 연동, mapx/mapy→WGS84 변환 필요 — `docs/AI파이프라인_Step별_설계_2026-08-09.md` Step3 참고 |
