...
| 지역 목록에 서울 "용산" 추가 | ✅ | 2026-08-11 | - | `lib/regions.ts`의 `REGIONS.서울`에 누락돼 있던 걸 발견해 추가. 백엔드 `app/services/regions.py`(광역 지역 자동 확장용, 2026-08-11 신규)도 같은 목록으로 복제해뒀으니 앞으로 지역 목록 바꿀 땐 두 파일 다 같이 고칠 것 |
